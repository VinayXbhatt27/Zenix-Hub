...
const Icon = {
  ...
  Brain: ({ size = 26 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M9.5 4.5a3 3 0 00-3 3V9a3 3 0 00-3 3c0 1.7 1.3 3 3 3h.5a3 3 0 003 3h1v-16h-1.5z" fill="currentColor" opacity=".85" />
      <path d="M14.5 4.5a3 3 0 013 3V9a3 3 0 013 3c0 1.7-1.3 3-3 3h-.5a3 3 0 01-3 3h-1v-16h1.5z" fill="currentColor" opacity=".85" />
    </svg>
  ),
  Message: ({ size = 26 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M4 6h16a2 2 0 012 2v6a2 2 0 01-2 2H9l-5 4V8a2 2 0 012-2z" stroke="currentColor" strokeWidth="1.6" fill="none" />
        ...
        <section className={styles.carouselSection} aria-label="AI Agents carousel">
          ...
          <div className={styles.carouselContainer}>
            ...
            <button
              ...
              onClick={() =>
                setCurrentSlide((p) => (p - 1 + aiAgents.length) % aiAgents.length)
              }
            ...
            <button
              ...
              onClick={() => setCurrentSlide((p) => (p + 1) % aiAgents.length)}
